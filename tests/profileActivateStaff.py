    ...
    def test_search_in_python_org(self):
        ...
        while(trigger):
            ...
            for row in range(0, j-i+1):
                ...
                if usr == user:
                    ...
                    staffed = driver.find_element(By.XPATH, "/html/body/div/div/div/div[2]/div[2]/div[2]/div[2]/div[2]/div/div/div/div[" + str(row + 1) + "]/div[7]/div[1]/a[2]/div").click()
                    staff = driver.find_element(By.XPATH, "/html/body/div/div/div/div[2]/div[2]/div[2]/div[2]/div[2]/div/div/div/div[" + str(row + 1) + "]/div[6]/div").text
                    print(staff)
        ...
        for klik in range(clicks):
            try:
                ...
                self.assertEqual("da", "ne", "ok") 
        self.assertEqual(staff, "true", "Is Active")
