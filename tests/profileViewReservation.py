...
class LoginTest(unittest.TestCase):
    ...
    def test_search_in_python_org(self):
        ...
        reservation = "63eb5f2a7a0592a92e34f3a8"
        ...
        while(trigger):
            ...
            for row in range(0, j-i+1):
                print(trigger)
                res = driver.find_element(By.XPATH, "/html/body/div/div/div/div[2]/div[2]/div[2]/div[2]/div[2]/div/div/div/div[" + str(row + 1) + "]/div[2]/div").text
                if res == reservation:
                    self.assertEqual(res, reservation, "Done")
                    view = driver.find_element(By.XPATH, "/html/body/div/div/div/div[2]/div[2]/div[2]/div[2]/div[2]/div/div/div/div[" + str(row + 1) + "]/div[7]/div[1]/a[1]/div").click()
                    print(view)
        ...
        offer = driver.current_url.split("/")[4]
        self.assertEqual(offer, reservation, "Should be equal")
