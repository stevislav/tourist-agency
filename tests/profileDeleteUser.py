        ...
        while(trigger):
            ...
            for row in range(0, j-i+1):
                ...
                if usr == user:
                    ...
                    activate = driver.find_element(By.XPATH, "/html/body/div/div/div/div[2]/div[2]/div[2]/div[2]/div[2]/div/div/div/div[" + str(row + 1) + "]/div[7]/div[1]/div").click()
                    ...
                    # print(activate)
                    # self.assertNotEqual(usr, user, "Deleted")
                    trigger = False
            if trigger == True:
                try:
                    btnNext.click()
